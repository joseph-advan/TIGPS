...
# Keep this variable name for dependent scripts; it now represents the final aligned
# roster source used for the 6603-student paired analysis.
BASIC_INFO_PATH = W2_DATA_PATH
