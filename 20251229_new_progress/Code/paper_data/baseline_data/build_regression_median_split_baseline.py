...
SUMMARY_CSV_PATH = OUT_DIR / "baseline_logistic_median_split_classification_summary.csv"
SUMMARY_MD_PATH = OUT_DIR / "baseline_logistic_median_split_classification_summary.md"
DETAIL_JSON_PATH = OUT_DIR / "baseline_logistic_median_split_classification_details.json"
LEGACY_OUTPUT_PATHS = [
    OUT_DIR / "baseline_regression_median_split_r2_summary.csv",
    OUT_DIR / "baseline_regression_median_split_r2_summary.md",
    OUT_DIR / "baseline_regression_median_split_r2_summary.txt",
    OUT_DIR / "baseline_regression_median_split_r2_details.json",
]
...
def main() -> None:
    ...
    for old_path in LEGACY_OUTPUT_PATHS:
        if old_path.exists():
            old_path.unlink()

    with open(SUMMARY_MD_PATH, "w", encoding="utf-8") as f:
        f.write("# Baseline: Logistic Regression on Median-Split Target (No Subscale Splitting)\n\n")
