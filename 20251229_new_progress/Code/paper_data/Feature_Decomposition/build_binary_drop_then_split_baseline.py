...
# Split groups requested via prior W2 split setup.
# Note: This split config follows the earlier W2 subscale definitions.
W2_SPLIT_SPECS: dict[str, dict[str, list[str]]] = {
    "v25": {
        "v25_A": [f"v25_{i}" for i in range(1, 4)],
        "v25_B": [f"v25_{i}" for i in range(4, 7)],
        "v25_C": [f"v25_{i}" for i in range(7, 16)],
    },
    "v26": {
        "v26_A": [f"v26_{i}" for i in range(1, 4)],
        "v26_B": [f"v26_{i}" for i in range(4, 7)],
    },
    "v27": {
        "v27_A": [f"v27_{i}" for i in range(1, 4)],
        "v27_B": ["v27_4"],
    },
    "v54": {
        "v54_A": [f"v54_{i}" for i in range(1, 4)],
        "v54_B": [f"v54_{i}" for i in range(4, 7)],
        "v54_C": [f"v54_{i}" for i in range(7, 10)],
    },
    "v23": {
        "v23_A": [f"v23_{i}" for i in range(1, 4)],
        "v23_B": [f"v23_{i}" for i in range(4, 7)],
        "v23_C": [f"v23_{i}" for i in range(7, 10)],
    },
}
...
def main() -> None:
    ...
    details: dict[str, Any] = {
        "settings": {
            ...
            "note": (
                "Binary model with drop-groups first, then split specified W2 groups into subscales."
            ),
            "drop_groups": {
